...
//
//     final getPropertyByLocation = getPropertyByLocationFromJson(jsonString);

import 'dart:convert';

GetPropertyByLocation getPropertyByLocationFromJson(String str) => GetPropertyByLocation.fromJson(json.decode(str));

String getPropertyByLocationToJson(GetPropertyByLocation data) => json.encode(data.toJson());

class GetPropertyByLocation {
    String status;
    String message;
    Data data;
    ...
    factory GetPropertyByLocation.fromJson(Map<String, dynamic> json) => GetPropertyByLocation(
        status: json["status"],
