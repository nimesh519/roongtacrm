...
class ProfilePage extends StatefulWidget {
  final GetLeadsResponseData? getLeadsResponse;

  ProfilePage({Key? key, this.getLeadsResponse}) : super(key: key);
  @override
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void getData() async {
    getPropertyByLocation = await ApiService().getByLocation(GetPropertylocReq(
        locationId: widget.getLeadsResponse!.prospectLocation!));
  }
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                centerTitle: true,
                title: AppbarTitle(text: "Follow-Up Details")),
                    ...
                    child: Column(
                        ...
                        children: [
                          Padding(
                              ...
                              child: Text(widget.getLeadsResponse!.name!,
                          ...
                          Padding(
                              ...
                              child: Text(widget.getLeadsResponse!.email!,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                          ...
                          GestureDetector(
                              onTap: () {
                                _makePhoneCall(
                                    "+91" + widget.getLeadsResponse!.phone!);
                              },
                              child: Padding(
                              ...
                              onTap: () async {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  FollowRequest followRequest = FollowRequest(
                                      leadId: widget.getLeadsResponse!.id,
                                      dateTime: _formatDate1(birthdayDate),
