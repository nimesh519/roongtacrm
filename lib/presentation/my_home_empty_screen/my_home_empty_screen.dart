...
class MyHomeEmptyScreen extends StatefulWidget {
  const MyHomeEmptyScreen({Key? key}) : super(key: key);

  @override
  State<MyHomeEmptyScreen> createState() => _MyHomeEmptyScreenState();
}

class _MyHomeEmptyScreenState extends State<MyHomeEmptyScreen> {
  ...
  void getLeads() async {
    getLeadsResponse = await ApiService().getAllLeadsApi();
        ...
        child: Scaffold(
          ...
          appBar: CustomAppBar(
              ...
              leading: AppbarIconbutton1(
                  ...
                  onTap: openAppDrawer),
              centerTitle: true,
              title: AppbarTitle(text: "Manage leads")),
          drawer: AppDrawer(
