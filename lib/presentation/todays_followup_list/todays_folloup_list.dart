...
import 'package:crm/presentation/view_leads/view_leads.dart';
import 'package:crm/presentation/view_leads/view_leads_todays_folloup.dart';
...
class TodaysFolloupList extends StatefulWidget {
  const TodaysFolloupList({Key? key}) : super(key: key);

  @override
  State<TodaysFolloupList> createState() => _TodaysFolloupListState();
}

class _TodaysFolloupListState extends State<TodaysFolloupList> {
  ...
  void getLeads() async {
    totResponse = await ApiService().fetchTodaysFollowupLeads();
    if (totResponse != null) {
      setState(() {});
    } else {
      setState(() {
        ...
        child: Scaffold(
          ...
          appBar: CustomAppBar(
              ...
              leading: AppbarIconbutton1(
                  ...
                  onTap: openAppDrawer),
              centerTitle: true,
              title: AppbarTitle(text: "Today's Follow Up Leads")),
          drawer: AppDrawer(
                ...
                children: [
                  totResponse != null
                      ? ListView.builder(
                          ...
                          itemCount: totResponse!.data!.length,
                          itemBuilder: (BuildContext context, int index) {
                            //  var reversedIndex = totResponse!.data!.length - index - 1;
                            var item = totResponse!.data![index];
