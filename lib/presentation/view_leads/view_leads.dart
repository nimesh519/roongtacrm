...
class ViewLeads extends StatefulWidget {
  ...
  ViewLeads({Key? key, this.leadId,this.from}) : super(key: key);
  @override
...
class _ViewLeadsState extends State<ViewLeads> {
  ...
  void getData()async {
    if(widget.from.toString()=="Wone"){
      viewLeads = await ApiService().getViewLeads(widget.leadId.toString());
      if (viewLeads != null) {
        setState(() {});
      } else {
        setState(() {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: SingleChildScrollView(
              child:viewLeads != null? Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          Padding(
                              ...
                              child: Text(viewLeads!.data!.name!,
                          ...
                          Padding(
                              ...
                              child: Text(viewLeads!.data!.empemail!,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        ...
                                        child: Text(
                                            "Enquire Date " +
                                                convertToDDMMYYYY(viewLeads!.data!.insertDate!,),
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                                                .txtManropeSemiBold14Gray900)),
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                        ...
                                        child: Text(
                                            "Followup Date " +
                                                convertToDDMMYYYY(viewLeads!.data!.updateDate!),
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                                                .txtManropeSemiBold14Gray900)),
